...
public final class Constants {
    ...
    public static final class ElevConstants {
        ...
        public static final ElevatorConstants CONSTANTS = new ElevatorConstants(GEARING, ROTATIONS_TO_METERS,
                SOFT_LIMITS, ZERO_OFFSET, CPR,
    ...
    public static final class WristConstants {
        ...
        public static final ProfiledPIDController PID = new ProfiledPIDController(6.9012, 0, 1.5006,
                new Constraints(5, 50));
